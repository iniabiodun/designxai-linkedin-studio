# LinkedIn Studio: a Design x AI workshop kit
...
| [prompts/04-loop.md](prompts/04-loop.md) | The weekly loop. Output: two scheduled tasks that write to your folder |
| [prompts/05-article.md](prompts/05-article.md) | For after the session. A task that turns a marked idea into a long-form first draft |
| [docs/VOICE-CARD.md](docs/VOICE-CARD.md) | The three decisions the assistant cannot make for you. Fill it in before the first prompt |
| [docs/MASTER-PROMPT.md](docs/MASTER-PROMPT.md) | Steps 0 to 4 in one paste, with a checkpoint at each step |

## Who it is for

Anyone who wants to post from their own work and does not. It works with 200 LinkedIn posts or none, with meeting notes or without, with a website or a single colour you like. The prompts read what you have and ask for what you do not.

## Licence

[CC BY 4.0](LICENSE). Use it, adapt it, run your own session with it. Credit the source.
