...
1. **Setup.** The assistant lists your connectors, reads your LinkedIn name and headline if you have one, and checks your folder exists. Nothing is written.
...
- Where things land: approved posts in <table>; ideas on one page per week called "Ideas, week of <day> <Month>", or as rows on an "Ideas" sheet if my folder cannot hold pages; meeting notes in <my meeting note taker, or "none">; long-form drafts inside the idea's own section as a toggle.
- Off-limits topics: <list>.

STEP 0: SETUP
List my connectors. Ask if I have LinkedIn; if yes, open linkedin.com/in/me in your browser and read my name and headline back; if no, ask me for the name and one line to show on posts and write both to memory. Confirm the folder "LinkedIn Studio" exists. Report in five lines. Wait.
